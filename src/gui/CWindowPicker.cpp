...
: CWindow(wlabel, wx, wy, ww, wh)
{
	...
	buttons[CAT_AIMBOT] = new CWindowButton("Aimbot", 5, 5, 92, 16, CAT_AIMBOT, this);
	buttons[CAT_AIMBOT2] = new CWindowButton("Aimbot Extra", 5, 5, 92, 16, CAT_AIMBOT2, this);
	buttons[CAT_VISUAL] = new CWindowButton("Visuals", 5, 5, 92, 16, CAT_VISUAL, this);
	buttons[CAT_VISUAL2] = new CWindowButton("Visuals Extra", 5, 5, 92, 16, CAT_VISUAL2, this);
	buttons[CAT_MISC] = new CWindowButton("Misc", 5, 5, 92, 16, CAT_MISC, this);
