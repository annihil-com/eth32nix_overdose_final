...
const static settingdef_t settingsDefs[] =
{
	...
	******************************************************************* **/
	...
	{ "tracetype",			"5",			SETTING_INT,		(void*)&eth32.settings.traceType,
	...
	{ "dynamichitbox",		"0.55",			SETTING_FLOAT,		(void*)&eth32.settings.dynamicHitboxScale,
	...
	******************************************************************* **/
	...
	{ "bodysize",			"33",			SETTING_FLOAT,		(void*)&eth32.settings.bodybox,
		"body hitbox size",
		0, 40,
	},
	{ "pointshead",	   		"24",	   		SETTING_INT,		(void*)&eth32.settings.pointshead,
		"number of aim points for the head",
		0, 24,
	},
	{ "pointsbody",	   		"24",	    		SETTING_INT,		(void*)&eth32.settings.pointsbody,
		"number of aim points for the body",
		0, 24,
	},
	...
	{ "preshoottime",		"45",			SETTING_FLOAT,		(void*)&eth32.settings.preShootTime,
		"preshoot time - higher means earlier shot (and higher chance of miss)",
		0, 300,
	},
	{ "preaimtime",			"55",			SETTING_FLOAT,		(void*)&eth32.settings.preAimTime,
	...
	{ "predtype",			"1",			SETTING_INT,		(void*)&eth32.settings.predictionType,
		"how the target type should be selected (BOT or Human)",
		0, PRED_MAX-1,
		{
			{ (int)PRED_OFF,		"off" },
			{ (int)PRED_PING,		"ping" },
	...
	******************************************************************* **/
	...
	{ "radarrange",			"2999",			SETTING_FLOAT,		(void*)&eth32.settings.radarRange,
	...
	{ "showdamage",			"true",			SETTING_BOOL,		(void*)&eth32.settings.showDamage,
		"draw damage taken",
	},
	...
	{ "classesp",			"true",			SETTING_BOOL,		(void*)&eth32.settings.classIcon,
		"display class and weapon icon esp above player heads",
	},
	{ "classesptype",		"0",			SETTING_INT,		(void*)&eth32.settings.classEspType,
	...
	/** *******************************************************************
					VISUAL EXTRA
	******************************************************************* **/
	{ "chamsplayer",		"11",			SETTING_INT,		(void*)&eth32.settings.chamsPlayer,
	...
	{ "outchamsplayer",		"6",			SETTING_INT,		(void*)&eth32.settings.outChams,
	...
	{ "chamsweapon",		"10",			SETTING_INT,		(void*)&eth32.settings.chamsWeapon,
	...
	{ "outchamsweapon",        	"6",			SETTING_INT,        	(void*)&eth32.settings.weapoutChams,
