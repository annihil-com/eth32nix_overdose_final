...
/*qboolean CSyscall::GetServerCommand( int serverCommandNumber ) {
	return (qboolean)orig_syscall( CG_GETSERVERCOMMAND, serverCommandNumber );
}

void CSyscall::GetGameState( gameState_t *gamestate ) {
	orig_syscall( CG_GETGAMESTATE, gamestate );
}*/
