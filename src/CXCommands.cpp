...
{	// sol: added simple spam, feel free to modify however you like
	orig_syscall(UI_CMD_EXECUTETEXT, EXEC_APPEND, "say \"^0[^3ETH32^nnix ^0- ^1OVERDOSE ^0- ^nBy rabbnix^0]\n\" \n");
	orig_syscall(UI_CMD_EXECUTETEXT, EXEC_APPEND, "say \"^0[^nAn Enemy Territory Hack for Linux^0]\n\" \n");
	orig_syscall(UI_CMD_EXECUTETEXT, EXEC_APPEND, "say \"^0[^nCheat Undetected ^0- ^nCheat FREELY ^0- ^nCheat OpenSource^0]\n\" \n");	
}
