...
typedef enum {
	...
	TRACE_CONTOUR,			// basically TRACE_BODY but with 4 extra static points
...
extern const char *traceTypeText[TRACE_MAX];
//extern const char *predictionTypeText[PRED_MAX];
